...
public class CodeGenerator {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG =
        new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/lte?serverTimezone=GMT%2B8", "root",
            "Q6^pw0*lb$@Ezv#&").typeConvert(new MySqlTypeConvert());
        ...
        FastAutoGenerator.create(DATA_SOURCE_CONFIG)
            ...
            .packageConfig(builder -> {
                builder.parent("team.lte") // 设置父包名
                    ...
                    .moduleName("businessquery");
            })
            // 策略配置
            .strategyConfig(builder -> {
                builder.addInclude("tbkpi", "tbprb") // 设置需要生成的表名
